...
const CAR_MODELS = [
  ...
  },
  {
    ...
    label: "PRIUS",
    icon: "🌿",
    imgUrl: "/manus-storage/car_prius_77a03321.png",
    desc: "次世代エコハイブリッド",
  ...
  },
  {
    ...
    label: "HARRIER",
    icon: "🦅",
    imgUrl: "/manus-storage/car_harrier_9dc10b54.png",
  ...
  },
  {
    ...
    label: "RAV4",
    icon: "🏔️",
    imgUrl: "/manus-storage/car_rav4_de9f4ee2.png",
    desc: "タフなコンパクトSUV",
  ...
  },
  {
    ...
    label: "ALPHARD",
    icon: "✨",
    imgUrl: "/manus-storage/car_alphard_c1e5953b.png",
    desc: "ラグジュアリーミニバン",
  ...
  },
  {
    ...
    label: "YARIS",
    icon: "🏙️",
    imgUrl: "/manus-storage/car_yaris_5aef67db.png",
    desc: "スマートなコンパクトカー",
  ...
  },
  {
    ...
    label: "COROLLA",
    icon: "🚗",
    imgUrl: "/manus-storage/car_corolla_a32ab7d3.png",
    desc: "信頼のファミリーセダン",
  ...
  },
  {
    ...
    label: "LAND CRUISER",
    icon: "🏕️",
    imgUrl: "/manus-storage/car_landcruiser_d58e0f13.png",
    desc: "本格オフロードSUV",
  ...
  },
  {
    ...
    label: "GR86",
    icon: "🏎️",
    imgUrl: "/manus-storage/car_86_53e89040.png",
    desc: "純粋スポーツクーペ",
  ...
  },
  {
    ...
    label: "NOAH",
    icon: "👨‍👩‍👧‍👦",
    imgUrl: "/manus-storage/car_noah_381cde37.png",
    desc: "広々ファミリーミニバン",
    colors: ["white", "black", "silver", "navy", "gray"],
  },
  {
    ...
    label: "FJ CRUISER",
    icon: "🟡",
    imgUrl: "/manus-storage/car_fj_cruiser_971d9fed.png",
    desc: "個性派レトロオフローダー",
  ...
  },
  {
    ...
    icon: "🪖",
    imgUrl: "/manus-storage/car_landcruiser_fj_083d37e3.png",
    desc: "伝説のクラシック4×4",
  ...
  },
  {
    ...
    icon: "🏔️",
    imgUrl: "/manus-storage/car_landcruiser_250_4e7f0a3f.png",
    desc: "最新世代フルサイズSUV",
          ...
          <div className="flex justify-center">
            <motion.img
              ...
              onError={(e) => {
                ...
                (e.target as HTMLImageElement).src = "/manus-storage/car_crown_d3b82223.png";
              }}
            />
          </div>
        </div>
